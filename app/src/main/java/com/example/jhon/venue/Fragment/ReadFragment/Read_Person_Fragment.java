...
public class Read_Person_Fragment extends Fragment implements RV_Swripe_Adapter.AddViewAdapterListener, RV_Swripe_Adapter.AddHolderListener {
    private static final String TAG= "Read_Page_Fragment";

    private View view;
    private RecyclerView rv_read_person;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view= LayoutInflater.from(getContext()).inflate(R.layout.read_page_person,null,false);
        Log.d(TAG,"Read_Person_Fragment");
...
//                    srl_read_page.setRefreshing(false);
    ...
    private void initRV() {
        rv_read_person= (RecyclerView) view.findViewById(R.id.rv_read_person);
        rv_read_person.setLayoutManager(new LinearLayoutManager(getContext()));
        rv_swripe_adapter=new RV_Swripe_Adapter(getContext(),rv_read_person);
        ...
        rv_read_person.setAdapter(rv_swripe_adapter);
    }

    private void initSWL() {
        srl_read_person= (SwipeRefreshLayout) view.findViewById(R.id.srl_read_person);
        srl_read_person.setColorSchemeColors(Color.parseColor("#FF4081"));
    }
    ...
    private void initListener() {
        srl_read_person.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
...
//            btn_card_main1_action2 = (Button) itemView.findViewById(R.id.btn_card_main1_action2);
    ...
    public static Read_Person_Fragment newInstance() {
        
        Bundle args = new Bundle();
        
        Read_Person_Fragment fragment = new Read_Person_Fragment();
